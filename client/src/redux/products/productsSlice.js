...
export const productsSlice = createSlice({
  ...
  reducers: {
    ...
    // getProductByIdForProductDetails
    productFetchedForProductDetails: (state, action) => {
      state.actionsLoading = false;
      state.productForDetails = action.payload.productForDetails;
      state.error = null;
    },
    // findProducts
    ...
    // productSoldReport
    productSoldFetched: (state, action) => {
      const { totalCount, productSold } = action.payload;
      state.listLoading = false;
      state.error = null;
    ...
    productCreated: (state, action) => {
      ...
      state.entities.unshift(action.payload.product);
    },
    // updateProduct
